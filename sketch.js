var bow , arrow,  background, redB, pinkB, greenB ,blueB ,arrowGroup, RedP, GreenP, BlueP, PinkP;
...
function draw() {
 background(0);
  ...
  fill("red");
  text("Red: "+RedP, 240, 50);
  fill("pink");
  text("Pink: "+PinkP, 180, 50);
  fill("blue");
  text("Blue "+BlueP, 125, 50);
  fill("green");
  text("Green: "+GreenP, 50, 50);
}
